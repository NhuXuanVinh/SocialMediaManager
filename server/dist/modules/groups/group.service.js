...
let GroupService = class GroupService {
    constructor(groupRepo, accountRepo, accountGroupRepo) {
        this.groupRepo = groupRepo;
        this.accountRepo = accountRepo;
        this.accountGroupRepo = accountGroupRepo;
    }
    async createGroup(userId, name) {
        const group = this.groupRepo.create({ group_name: name, user: { id: userId } });
    ...
    async removeAccountFromGroup(groupId, accountId) {
        ...
        if (!join)
            throw new Error('Account not found in this group');
...
exports.GroupService = GroupService = __decorate([
    ...
    __param(2, (0, typeorm_1.InjectRepository)(account_group_entity_1.AccountGroup)),
